...
prepareRFU <- function(pathIn,adatFile){
  ...
  PlateScale_Reference <<- attributes(SomaDataIO::read_adat(paste0(pathIn,"SS-228545_v4.1.hybNorm.medNormInt.plateScale.calibrate.anmlQC.qcCheck.20220224.adat")))$Col.Meta$PlateScale_Reference
