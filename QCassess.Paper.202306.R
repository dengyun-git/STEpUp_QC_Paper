...
getFrarmeList <- function(pathIn,MySoma,ProMeta){
  ...
  ClinicFrame <- read.csv(paste0(pathIn,'QCmetadata/discovery_QApheno_1_120522.csv'))
  ClinicFrameTempSup <- read_excel(paste0(pathIn,'QCmetadata/Additional data for Yun_TP_27-05-22.xlsx'))
  ...
  ###SIN mapper
  SINmap <- read.csv(paste0(pathIn,'somascan/adat/adat_to_redcap_SIN_map.csv'),sep=" ")
