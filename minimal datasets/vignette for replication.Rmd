...
library(plyr)
path <- c(
  "minimal datasets/PC1 Driver - Standardisation",
  "minimal datasets/PC1 Driver - Intracellular Protein Score",
  "minimal datasets/PC2 Driver - Bimodal Signal",
  "minimal datasets/Compare to Immunoassay",
  "minimal datasets/Disease Group After Filtering")
...
```{r Optimal Synovial Fluid Standardisation, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Variation explained by top 10 PCs after standardisation and IPS adjustment, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Visualization of PC1 driver -- protein abundance, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r PC1 of 18 paired spun/unspun samples, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Intracellular protein score vs PC1 on the IPS adjusted and non-adjusted data, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r PC1 driver regression model, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r UMAP before and after batch correction, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r TSG101 vs processing batch, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r TSG101 when reprocessed, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Compare to Immunoassay, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Disease Group After Filtering, echo=TRUE, message=FALSE, warning=FALSE}
