---
title: "STEpUP OA: Script used to process 'minimal' dataset required to generate plots
  in our Quality-Control (QC) Manuscript"
output:
  html_document:
    keep_md: yes
    toc: yes
...
The full STEpUP OA dataset may be made available by application to the Data Access and Publication Group of STEpUP OA (stepupoa@kennedy.ox.ac.uk) once the primary analysis manuscript is published, in accordance with what is stipulated in our Consortium Agreement. The minimal datasets to replicate figures and corresponding R code are provided here. 
